-- ══════════════════════════════════════════════════════════════════
-- ONE FILE: create customer_profiles + seed all 16 cPanel test accounts
-- Run this entire script in Supabase SQL Editor (safe to re-run)
-- Requires: loyalty_accounts + leads tables already exist
-- ══════════════════════════════════════════════════════════════════

-- 1) Create table (this was missing — causes "relation does not exist")
...
-- 4) CRM leads (skip if leads table missing)
...
select
  ...
  'import', 'general', 'Test account', 'new', p.notes,
  jsonb_build_object(
...
-- 5) Verify
select email, first_name, last_name, city, is_test
